...
int main(void)
{
  ...
  /* Initialize nrf24l01 */
  nrf24l01.nrf24l01GpioPort = CSN_GPIO_Port;
  ...
  /* Testing */
  NRF24L01_Write_Byte(&nrf24l01, RX_PW_P0, 18);
  /* End of testing */
  ...
  HAL_StatusTypeDef status =  NRF24L01_Init(
    ...
    PTX,
    FIVE_BYTES_ADDR,
    0x04, 0xF, //500uS delay, 15 re-transmissions
    ONE_MBPS_DATA_RATE,
    RF_POWER_1,
    LNA_HCURR_RESET
  );
  ...
  /* end Initialize nrf24l01 */
  
  NRF24L01_Print_Info(&nrf24l01);

  
  char payload[18] = "masz_piekne_cycole";
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    NRF24L01_Write_Tx_Payload(&nrf24l01, payload, 18);
    NRF24L01_Send_Payload(&nrf24l01);
    HAL_Delay(1000);
